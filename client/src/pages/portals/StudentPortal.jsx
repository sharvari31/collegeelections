    ...
    <main className="min-h-screen bg-gradient-to-b from-white via-pink-50 to-red-50 py-12 px-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow border border-pink-100 p-6 flex flex-wrap items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-red-700">Student Election</h1>
            <p className="text-gray-600">
              Vote for your student council leaders or apply to stand as a candidate.
            </p>
            {me && (
          ...
          {POSITIONS.map((p) => (
            ...
            >
              ...
              <div className="mt-4 flex gap-2">
                <a
                  href={`/candidates?role=student&position=${encodeURIComponent(p)}`}
